...
* **Expected data:** Metadata (source of experimental variables).

>Uniform and informative short sample IDentifiers are crucial in the downstream analysis.
...
* DNA sequencing protocol 2: [Illumina](https://www.illumina.com/content/dam/illumina-support/documents/documentation/chemistry_documentation/16s/16s-metagenomic-library-prep-guide-15044223-b.pdf) 
