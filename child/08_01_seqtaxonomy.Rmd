...
*  Input file: *.nr.wang.pick.pick.tax.summary* file. 
* All chimeras, non-bacterial lineages and mock sequences have been removed

```{r seqtaxsummary, echo=TRUE, message=FALSE, warning=FALSE}
taxsummary = read.table(file="../data/mothur/phylotype/qced.trim.contigs.good.unique.good.filter.unique.precluster.pick.nr.wang.pick.pick.tax.summary", stringsAsFactors=FALSE, header=T, sep='\t')

# Save taxsummary object 
write.table(taxsummary, "../results/tables/phylotype/seq_taxonomy/taxsummary.tsv", append = FALSE, quote = FALSE, sep="\t", row.names = FALSE, col.names = TRUE)
```

**Format of *.nr.wang.pick.pick.tax.summary* file**
```{r, echo=TRUE}
library(kableExtra)
...
```{r, echo=TRUE}
write.table(phylum.a,"../results/tables/phylotype/seq_taxonomy/phylum.a.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(class.a,"../results/tables/phylotype/seq_taxonomy/class.a.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(order.a,"../results/tables/phylotype/seq_taxonomy/order.a.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(family.a,"../results/tables/phylotype/seq_taxonomy/family.a.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(genus.a,"../results/tables/phylotype/seq_taxonomy/genus.a.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)
```
...
```{r, echo=TRUE}
write.table(phylum,"../results/tables/phylotype/seq_taxonomy/phylum.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(class,"../results/tables/phylotype/seq_taxonomy/class.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(order,"../results/tables/phylotype/seq_taxonomy/order.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(family,"../results/tables/phylotype/seq_taxonomy/family.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(genus,"../results/tables/phylotype/seq_taxonomy/genus.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)
```
...
```{r, echo=TRUE}
phylum<-read.table(file="../results/tables/phylotype/seq_taxonomy/phylum.tsv", header = TRUE, sep="\t")
phylum.t = setNames(data.frame(t(phylum[,-1])), phylum[,1])
class<-read.table(file="../results/tables/phylotype/seq_taxonomy/class.tsv", header = TRUE, sep="\t")
class.t = setNames(data.frame(t(class[,-1])), class[,1])
order<-read.table(file="../results/tables/phylotype/seq_taxonomy/order.tsv", header = TRUE, sep="\t")
order.t = setNames(data.frame(t(order[,-1])), order[,1])
family<-read.table(file="../results/tables/phylotype/seq_taxonomy/family.tsv", header = TRUE, sep="\t")
family.t = setNames(data.frame(t(family[,-1])), family[,1])
genus<-read.table(file="../results/tables/phylotype/seq_taxonomy/genus.tsv", header = TRUE, sep="\t")
...
```{r, echo=TRUE}
write.table(phylum.t,"../results/tables/phylotype/seq_taxonomy/phylum.t.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
write.table(class.t,"../results/tables/phylotype/seq_taxonomy/class.t.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
write.table(order.t,"../results/tables/phylotype/seq_taxonomy/order.t.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
write.table(family.t,"../results/tables/phylotype/seq_taxonomy/family.t.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
write.table(genus.t,"../results/tables/phylotype/seq_taxonomy/genus.t.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
```
...
```{r, echo=TRUE}
write.table(phylumprop,"../results/tables/phylotype/seq_taxonomy/phylumprop.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
write.table(classprop,"../results/tables/phylotype/seq_taxonomy/classprop.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
write.table(orderprop,"../results/tables/phylotype/seq_taxonomy/orderprop.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
write.table(familyprop,"../results/tables/phylotype/seq_taxonomy/familyprop.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
write.table(genusprop,"../results/tables/phylotype/seq_taxonomy/genusprop.tsv", append = FALSE, quote = FALSE, sep="\t", eol = "\n", na = "NA", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"))
```
...
```{r, echo=TRUE}
write.table(phylum.t.v,"../results/tables/phylotype/seq_taxonomy/phylum.t.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(class.t.v,"../results/tables/phylotype/seq_taxonomy/class.t.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(order.t.v,"../results/tables/phylotype/seq_taxonomy/order.t.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(family.t.v,"../results/tables/phylotype/seq_taxonomy/family.t.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(genus.t.v,"../results/tables/phylotype/seq_taxonomy/genus.t.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)



write.table(phylumprop.v,"../results/tables/phylotype/seq_taxonomy/phylumprop.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(classprop.v,"../results/tables/phylotype/seq_taxonomy/classprop.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(orderprop.v,"../results/tables/phylotype/seq_taxonomy/orderprop.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(familyprop.v,"../results/tables/phylotype/seq_taxonomy/familyprop.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)

write.table(genusprop.v,"../results/tables/phylotype/seq_taxonomy/genusprop.v.tsv", quote = FALSE, sep="\t",
            row.names = FALSE, col.names = TRUE)
```
