# Sequence processing
* Adopted *mothur* pipeline [@Schloss2009] with few modifications

## Download latest stable version of *mothur* and put it into the code directory
...
* Forward and reverse reads are joined then screened
* At each step a summary file is generated
* Review the summary before proceeding
* Optionally set to use four processors
```{}
...
* Download SILVA database ana put the files into the data/references directory
...
* SILVA [@] is our pick, is highly curated
