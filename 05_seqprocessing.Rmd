...
* Put it into the code directory
...
* Forward and reverse read are joined to form a single sequence
* At each step a summary file is generated
* Review the summary before proceeding
* Optionally set to use four processors
* The output will be screened to filter out too short and too long sequences. 
```{}
